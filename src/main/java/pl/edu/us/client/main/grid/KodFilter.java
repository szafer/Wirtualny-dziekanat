...
import pl.edu.us.shared.enums.KodNazwaProvider;

public class KodFilter<M, V extends KodNazwaProvider> extends Filter<M,V> {
    ...
    public KodFilter(ValueProvider<? super M, V> valueProvider) {
        super(valueProvider);

...
public class MenuBuilder {
	...
	private MenuBarItem buildSymulacjaMenu() {
		...
		// TODO jak dziewczyny coś
		// wymyślą
		// symulacjaMenu.add(createMenuItem("Przychody i koszty - roczne",
		// NameTokens.przychodykosztyroczne));
	...
	private MenuBarItem buildStudentMenu() {
		...
		// studentMenu.add(createMenuItem("Kierunki Studenta",
		// NameTokens.kierunkiStudenta));
		// studentMenu.add(createMenuItem("Oceny Studenta",
		// NameTokens.ocenyStudenta));
	...
	private MenuBarItem buildZamknijMenu() {
		...
		// zamknij
		zamknijBarItem = new MenuBarItem("Zamknij", zamknijMenu);

...
public class KartotekaUzytkownikowPresenter extends
    BasePresenter<KartotekaUzytkownikowPresenter.MyView, KartotekaUzytkownikowPresenter.MyProxy> implements
    KartotekaUzytkownkowUiHandlers {

    public interface MyView extends View, HasUiHandlers<KartotekaUzytkownkowUiHandlers> {

        KartotekaUzytkownikowModel getModel();
    }

    @ProxyCodeSplit
    @NameToken(NameTokens.kartotekaUzytkownikow)
    public interface MyProxy extends ProxyPlace<KartotekaUzytkownikowPresenter> {
    }
    ...
    @Inject
    public KartotekaUzytkownikowPresenter(EventBus eventBus, MyView view, MyProxy proxy) {
